...
az webapp config appsettings set \
  ...
  --settings \
    ...
    SPRING_DATASOURCE_URL="jdbc:postgresql://$PGHOST:5432/$DBNAME?sslmode=require" \
    SPRING_DATASOURCE_USERNAME="futurestack" \
...
az webapp deployment github-actions add --name "$WEBAPP_NAME" --resource-group "$RG" --repo "Maciel0123/sprint3-java-devops" --branch "main" --login-with-github
...
echo "Acesse seu App Service através do link: $WEBAPP_NAME.azurewebsites.net"
